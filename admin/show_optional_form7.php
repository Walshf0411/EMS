        ...
        <table style="width:100%;">
            ...
            <tr>
                <?php 
                    ...
                    require_once("../utils/globals.php");
                ?>
                <td colspan="3">Submission Date - <?php echo getSubmissionDates($conn)['optional_form7_deadline'];?></td>
            </tr>
        </table>
    </p>
            ...
            <div class="modal-body">
                ...
                <form action="#" method="POST">
                    <div class="form-group">
                        <label for="rejection_message_form7"><strong>Enter a message to send to the exhibitor:</strong></label>
...
<?php
    ...
    if (isset($_POST['reject_form7'])) {
        ...
        $checkQuery = "SELECT * FROM exhibitor_forms_submitted WHERE exhibitor_id=".$_GET['id'];
        $checkQueryResults = executeQuery($conn, $checkQuery);
        if ($checkQueryResults->fetch_assoc()['optional_form7'] == 2 || $checkQueryResults->fetch_assoc()['optional_form7'] == 3) {
            // already verified, cannot reject.
            notify("Optional form 7 has been already reviewed, cannot reject.", "warn");
        } else {
            $setQuery = "UPDATE exhibitor_forms_submitted SET optional_form7 = 3 where exhibitor_id = ".$_GET["id"];
            $queryResult = executeQuery($conn,$setQuery);
            if ($queryResult) {
                ...
                $rejectionMessage = $_POST['rejection_message_form7'];
                $subject = "Electrical Fittings 2 form reviewed for $exhibitionName.";
                $mainHeader = "Electrical Fittings 2 has been reviewed successfully.";
                $mailBody = "Your Electrical Fittings 2 form submission has been rejected by the admin.<br>
                The admin says:";
