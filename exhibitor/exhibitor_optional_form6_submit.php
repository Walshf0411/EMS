<?php
    ...
    if (isset($_POST['selected_items'])) {
        ...
        if(executeQuery($conn, $query)){
            ...
            logToDb($conn, $_SESSION["user_id"], "ELECTRICAL FITTINGS");
            ...
            ";
            $mainHeader = "$participantName has submitted optional form 6.";
            $subject = "$participantName submitted optional form 6.";
