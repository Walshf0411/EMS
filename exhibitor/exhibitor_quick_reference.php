...
<div class="table-wrapper">
    <table width=100% class="table">
        <thead>
            <tr>
                <th colspan=4 class="w-25">Organizer Team</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="w-25"><div>Chief Organizer</div></td>
                <td class="w-25"><div>Mr. Yusuf Dohadwala</div></td>
                <td align=center class="w-25">--</td>
