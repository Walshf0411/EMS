...
function renderToString($context, $fileName) {
    extract($context);
    ob_start();
    include "../mail_templates/".$fileName;
...
echo renderToString($context, 'base.php');
// file name is got to be the name of a file as if we were in the mail_templates directory
// */
?>